...
public class DomainNetCheckJob extends ServiceFactory implements Job {
    ...
    public void execute(JobExecutionContext context) {
        ...
        if(isFound.isPresent()){
            String payload = isFound.get().getKeyword() + ".net";
            ...
            try (Socket socket = new Socket(WHOIS_HOST, WHOIS_PORT)) {
                ...
                try (BufferedReader input = new BufferedReader(new InputStreamReader(socket.getInputStream()))) {
                    ...
                    if(line != null){
                        ...
                        processedWordsService.updateNetDomainById(id, false);
                    } else {
                        ...
                        processedWordsService.updateNetDomainById(id, true);
                    }
                }
