...
import com.google.api.ads.adwords.axis.v201809.o.*;
...
import org.engine.production.service.DataEntityService;
...
public class DataPagesController {
    ...
    public DataPagesController(DataEntityService dataEntityService) {
        this.dataEntityService = dataEntityService;
    }

    @PostMapping(value = "/create", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<?> create(@Valid @RequestBody DataEntityDto dto){
